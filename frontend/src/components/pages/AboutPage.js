    ...
    return (
        <div className="about-container">
            ...
            <div className="about-content">
                <img src={`${process.env.PUBLIC_URL}/Personal Profile Pic.JPG`} alt="Toh Hong Jing" className="profile-image" />
                <div className="about-text">
                    ...
                    <p>Email: <a href="hongjing123321@gmail.com">hongjing123321@gmail.com</a></p>
